	  ...
	  if(ipar > 2)
	    {
	      ...
	      std::cout << "draw line for ipar " << ipar << " layer " << layer << " with " << mvtx_stave_mean[layer][ipar-3] << std::endl;
	      
	      //	      offset.DrawLine(0,xyz_silicon[ipar-3][layer] ,xmax, xyz_silicon[ipar-3][layer]);
	      offset.DrawLine(0, mvtx_stave_mean[layer][ipar-3], xmax, mvtx_stave_mean[layer][ipar-3]);
	    }
